...
public class my_info_modify_page extends AppCompatActivity {
    ...
    protected void onCreate(Bundle saveInstanceState) {
        ...
        setContentView(R.layout.my_info_modify_page);
            ...
            public void onClick(View v) {
                switch (v.getId()) {
                    ...
                    case R.id.storage_bt:
                        ...
                        startActivity(m);
                        Toast.makeText(getApplicationContext(), "사용자 정보가 저장 되었습니다.", Toast.LENGTH_LONG).show();
                        break;
                }
            }
        };
